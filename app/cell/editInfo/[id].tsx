...
export default function EditCellInfo() {
	const {
		cellByIdData,
		allUsers,
		handleChange,
	...
	useEffect(() => {
		if (cellByIdData?.cell) {
			setCell({
				name: cellByIdData.cell.name,
				leaderId: cellByIdData.cell.leaderId ? cellByIdData.cell.leaderId.toString() : "",
				meetingDay: cellByIdData.cell.meetingDay,
				meetingTime: new Date(cellByIdData.cell.meetingTime),
				location: cellByIdData.cell.location,
			});
		}
	}, [cellByIdData]);
		...
		>
			...
			<View className="flex-col w-[80%] h-auto mt-4">
				...
				<TextInput
					...
					id="name"
					className="bg-[#ebebeb] border-[#73937e] rounded-lg w-full h-12 mt-2 mb-4 justify-center px-4"
				...
				{allUsers?.users.length === 0 ? (
					...
					<View className="bg-[#ebebeb] focus:border-[#73937e] rounded-lg w-full h-12 mt-2 mb-4 justify-center">
						<Picker
							selectedValue={cell.leaderId.toString()}
				...
				<View className="bg-[#ebebeb] border-[#73937e] rounded-lg w-full h-12 mt-2 mb-4 justify-center">
					<Picker
				...
				{showTimePicker && (
					<DateTimePicker
						value={new Date(cell.meetingTime!)}
						mode="time"
						display="default"
						onChange={(
